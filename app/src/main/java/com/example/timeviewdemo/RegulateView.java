package com.byd.carlauncher.ui.view;
...
import com.byd.carlauncher.utils.ImageUtils;
...
public class RegulateView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        regulator = ImageUtils.drawable2Bitmap(getResources().getDrawable(R.drawable.up_down));
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (!isClick) {
                    ...
                    postInvalidate();
                    if (listener != null) {
                        listener.onValueChanged(genValue());
                    }
                }
                break;
